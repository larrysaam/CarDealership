...
const Edit =({edit, setEdit})=>{
    ...
    const handleClick = async()=>{
        ...
        if(edit_Length > 0){
            ...
            //code
            await axios.patch(`${process.env.REACT_APP_BACKEND_URL}/vehicle/`,
            ...
            await axios({
                method: "post",
                url: `${process.env.REACT_APP_BACKEND_URL}/vehicle`,
                data: bodyFormData,
    ...
    return(
        <div className='main_edit_container'>
            ...
            <div className='edit_image_container'>
                ...
                images.map(img =>{
                    return(<img src={`${process.env.REACT_APP_BACKEND_URL}/${img}`} alt={`${process.env.REACT_APP_BACKEND_URL}/${img}`} id='edit_image'/>)
                })
                : 
                urlImages.map(img =>{
